          ...
          {layers.map((layer, index) => {
            ...
            return (
              <div key={layer.number} className="layer" data-testid={layer.testId}>
                <div className="relative border-2 border-white/30 rounded-lg p-8 md:p-10 bg-white/10 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
