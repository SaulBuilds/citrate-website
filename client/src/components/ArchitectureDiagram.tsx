          ...
          {layers.map((layer, index) => {
            ...
            return (
              <div key={layer.number} className="layer" data-testid={layer.testId}>
                <div className="relative border-2 border-zinc-700 rounded-lg p-8 md:p-10 bg-zinc-900 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
